        ...
        <div class="container" id="main_container">
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    <li data-target="media/images/.jpg" data-slide-to="0" class="active"></li>
                    <li data-target="media/images/.jpg" data-slide-to="1"></li>
                    <li data-target="media/images/.jpg" data-slide-to="2"></li>
                </ol>
            ...
            <div class="row ">
                ...
                <div class="col-xs-4 col-md-4">
                    ...
                    <div class="thumbnail">
                        <a href="full_beds.php.php"><img src="media/images/beds/queen_half.jpg" alt="Full Sized Murhpy Bed"></a>
                        <div class="caption">
                ...
                <div class="col-xs-4 col-md-4">
                    ...
                    <div class="thumbnail">
                        <a href="double_beds.php.php"><img src="media/images/beds/queen_1.jpg" alt="Double Sized Murhpy Bed"></a>
                        <div class="caption">
